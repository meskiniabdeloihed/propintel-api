...
REFERENTIEL = {
    ...
    "Agdal":                        {"appt": 25000, "villa": 9021,  "dar": 13876, "riad": None,  "liq": 3},
    ...
    "Gueliz":                       {"appt": 15000, "villa": 14588, "dar": 12107, "riad": None,  "liq": 3},
    ...
    "Hivernage":                    {"appt": 22000, "villa": 16919, "dar": 12905, "riad": None,  "liq": 3},
    ...
    "Prestigia":                    {"appt": 23000, "villa": 12277, "dar": 16581, "riad": None,  "liq": 3},
...
def get_leads():
    try:
        ...
        logger.error("Erreur get_leads: " + str(e))
        return jsonify({"error": str(e)}), 500
